...
import Math, { add, subtract, multiply, divide } from "./Math"; // Importing both default and named exports
import * as Matematica from "./Math"; // Importing everything as Matematica
