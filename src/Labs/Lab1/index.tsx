    ...
    <div id="wd-lab1">
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <br /> <label htmlFor="wd-text-fields-last-name"> Last name: </label>{" "}
          <input
            type="text"
        ...
        <h4 id="wd-dropdowns">Dropdowns</h4> <h5>Select one</h5>{" "}
        ...
        <input
          ...
          value="100000"
        />
        <br /> <label htmlFor="wd-text-fields-rating"> Rating: </label>{" "}
        <input
          type="range"
          ...
          value="4"
        />
        <br /> <label htmlFor="wd-text-fields-dob"> Date of birth: </label>{" "}
